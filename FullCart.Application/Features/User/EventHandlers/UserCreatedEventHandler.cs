...
public class UserCreatedEventHandler : INotificationHandler<UserCreatedEvent>
{
    ...
    public UserCreatedEventHandler(ILogger<UserCreatedEventHandler> logger, IUserTransactionService userTransactionService)
    {
        _logger = logger;
    ...
    public Task Handle(UserCreatedEvent notification, CancellationToken cancellationToken)
    {
        ...
        userTransaction.TransactionTypeId = (long)TransactionTypeEnum.UserCreated;
        ...
        userTransaction.CreatedBy = user.CreatedBy;
